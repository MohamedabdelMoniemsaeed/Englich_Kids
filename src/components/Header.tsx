...
const TITLE_MAP: Record<ScreenId, { en: string; ar: string }> = {
  ...
  fruits: { en: 'Delicious Fruits', ar: 'الفواكه اللذيذة' },
  vegetables: { en: 'Healthy Vegetables', ar: 'الخضروات الصحية' },
  weather: { en: 'Weather Conditions', ar: 'حالات الطقس والجو' },
  seasons: { en: 'The 4 Seasons', ar: 'فصول السنة الأربعة' },
